...
<body>
		<table>
			<tr><td colspan="3">스케쥴리스트</td><td colspan="1"></td><td colspan="1"></td></tr>
			<tr><td><a href="/MentoringProject/insertScheduleView.do?productpk=${dto.productpk }">스케쥴추가하기</a></td>
		<td colspan="3"><a href="/MentoringProject/mentorProductPage.do?productpk=<%=ShareVar.productpk%>">돌아가기</a></td>	</tr>
...
  <td align="center"><input type="hidden" name=pk${status.index} value=""/>
<a href="/MentoringProject/deleteSchedule.do?schedulepk=${dto.schedulepk}">삭제</a></td>
		</tr>
	</c:forEach>
		</table>
</body>
