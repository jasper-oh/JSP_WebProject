...
<table>
		...
		<tr>
			<td align="left">제목 :</td><td align="left"><input type="text" name="questiontitle" size="15" value="${QuestionData.questiontitle }"></td>
		</tr>
		<tr>
		...
		<tr>
			<td><textarea rows="40" cols="70" name="questiontext">${QuestionData.questiontext }</textarea> </td>
		</tr>
</table>
</form>
